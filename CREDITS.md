...
- **Ilustraciones oficiales** — servidas desde el repositorio público de sprites de PokéAPI (https://github.com/PokeAPI/sprites).
...
Pendiente (fase 5). Cada pista y efecto se registrará aquí con su licencia y atribución.
